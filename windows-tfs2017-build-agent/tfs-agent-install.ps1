...
function Test-Parameters
{
    ...
    {
        Write-Error "TFS url '$TfsUrl' doesn't look like a URL."
    }
...
function Install-Agent
{
    ...
    try
    {
        ...
        $agentConfigArgs = "--unattended", "--url", $Config.ServerUrl, "--auth", "PAT", "--token", $Config.TfsUserPassword, "--pool", $Config.PoolName, "--agent", $Config.AgentName, "--runasservice", "--windowslogonaccount", $Config.WindowsLogonAccount
...
try
{
    ...
    $agentPackagePath = Download-AgentPackage
